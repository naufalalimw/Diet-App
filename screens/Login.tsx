  ...
  navigation,
    ...
    return (
        <><View style={styles.container}>
            <ImageBackground source={{uri:'https://i.ibb.co/DDgdqcr/logo-trofo.png'}} imageStyle={{ opacity: 1 }} resizeMode="contain" style={styles.head}>
                {/* <Text style={styles.title}>Masuk</Text>
                <Text style={styles.subtitle}>Masukan informasi untuk{"\n"}mengakses akunmu</Text> */}
            </ImageBackground>
            <View><Text style={styles.title}>Login</Text>
            </View>
